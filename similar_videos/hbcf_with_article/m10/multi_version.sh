...
python add_play_ratio.py --input_play_ratio_file ${preprocessed}.play_ratio --input_nn_result_file ${fast_model}.result.raw --output_result_file ${fast_model}.result --nn_k ${nn_k} --nn_score_weight 0.3
