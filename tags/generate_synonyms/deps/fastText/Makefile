...
OBJS = args.o dictionary.o productquantizer.o matrix.o qmatrix.o vector.o model.o utils.o fasttext.o mockmain.o
INCLUDES = -I.
...
mockmain.o: src/mockmain.cc src/*.h
	$(CXX) $(CXXFLAGS) -c src/mockmain.cc
