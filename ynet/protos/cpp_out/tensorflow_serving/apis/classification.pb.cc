...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(Class)},
  { 7, -1, sizeof(Classifications)},
  { 13, -1, sizeof(ClassificationResult)},
  { 19, -1, sizeof(ClassificationRequest)},
  { 26, -1, sizeof(ClassificationResponse)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Class_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Class_default_instance_);_Classifications_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Classifications_default_instance_);_ClassificationResult_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ClassificationResult_default_instance_);_ClassificationRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ClassificationRequest_default_instance_);_ClassificationResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ClassificationResponse_default_instance_);_ClassificationRequest_default_instance_._instance.get_mutable()->model_spec_ = const_cast< ::tensorflow::serving::ModelSpec*>(
      ::tensorflow::serving::ModelSpec::internal_default_instance());
  _ClassificationRequest_default_instance_._instance.get_mutable()->input_ = const_cast< ::tensorflow::serving::Input*>(
      ::tensorflow::serving::Input::internal_default_instance());
  _ClassificationResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::tensorflow::serving::ClassificationResult*>(
...
void ClassificationResult::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->classifications(static_cast<int>(i)), output);
  }
