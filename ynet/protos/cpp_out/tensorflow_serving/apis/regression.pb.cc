...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 6, -1, sizeof(RegressionResult)},
  { 12, -1, sizeof(RegressionRequest)},
  { 19, -1, sizeof(RegressionResponse)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Regression_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Regression_default_instance_);_RegressionResult_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RegressionResult_default_instance_);_RegressionRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RegressionRequest_default_instance_);_RegressionResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RegressionResponse_default_instance_);_RegressionRequest_default_instance_._instance.get_mutable()->model_spec_ = const_cast< ::tensorflow::serving::ModelSpec*>(
      ::tensorflow::serving::ModelSpec::internal_default_instance());
  _RegressionRequest_default_instance_._instance.get_mutable()->input_ = const_cast< ::tensorflow::serving::Input*>(
      ::tensorflow::serving::Input::internal_default_instance());
  _RegressionResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::tensorflow::serving::RegressionResult*>(
...
void RegressionResult::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->regressions(static_cast<int>(i)), output);
  }
