...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<PredictRequest::PredictRequest_InputsEntry>
     _instance;
...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<PredictResponse::PredictResponse_OutputsEntry>
     _instance;
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorflow_serving/apis/predict.proto", schemas, file_default_instances, TableStruct::offsets, factory,
      file_level_metadata, NULL, NULL);
file_level_metadata[0].reflection = PredictRequest::PredictRequest_InputsEntry::CreateReflection(file_level_metadata[0].descriptor, _PredictRequest_InputsEntry_default_instance_._instance.get_mutable());
file_level_metadata[2].reflection = PredictResponse::PredictResponse_OutputsEntry::CreateReflection(file_level_metadata[2].descriptor, _PredictResponse_OutputsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _PredictRequest_InputsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PredictRequest_InputsEntry_default_instance_);_PredictRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PredictRequest_default_instance_);_PredictResponse_OutputsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PredictResponse_OutputsEntry_default_instance_);_PredictResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PredictResponse_default_instance_);_PredictRequest_InputsEntry_default_instance_._instance.get_mutable()->set_default_instance(_PredictRequest_InputsEntry_default_instance_._instance.get_mutable());
  _PredictRequest_InputsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _PredictRequest_default_instance_._instance.get_mutable()->model_spec_ = const_cast< ::tensorflow::serving::ModelSpec*>(
      ::tensorflow::serving::ModelSpec::internal_default_instance());
  _PredictResponse_OutputsEntry_default_instance_._instance.get_mutable()->set_default_instance(_PredictResponse_OutputsEntry_default_instance_._instance.get_mutable());
  _PredictResponse_OutputsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
...
PredictRequest::PredictRequest()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::InitDefaults();
  }
  SharedCtor();
