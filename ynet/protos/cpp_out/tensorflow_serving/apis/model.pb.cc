...
void TableStruct::InitDefaultsImpl() {
  ...
  _ModelSpec_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ModelSpec_default_instance_);_ModelSpec_default_instance_._instance.get_mutable()->version_ = const_cast< ::google::protobuf::Int64Value*>(
...
#if LANG_CXX11
void ModelSpec::set_name(::std::string&& value) {
...
#if LANG_CXX11
void ModelSpec::set_signature_name(::std::string&& value) {
