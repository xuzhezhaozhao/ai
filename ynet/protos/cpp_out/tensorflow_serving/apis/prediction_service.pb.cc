...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorflow_serving/apis/prediction_service.proto", schemas, file_default_instances, TableStruct::offsets, factory,
      NULL, NULL, NULL);
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::tensorflow::serving::protobuf_tensorflow_5fserving_2fapis_2fget_5fmodel_5fmetadata_2eproto::InitDefaults();
  ::tensorflow::serving::protobuf_tensorflow_5fserving_2fapis_2finference_2eproto::InitDefaults();
  ::tensorflow::serving::protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::InitDefaults();
...
void AddDescriptorsImpl() {
  ...
  ::tensorflow::serving::protobuf_tensorflow_5fserving_2fapis_2fget_5fmodel_5fmetadata_2eproto::AddDescriptors();
  ::tensorflow::serving::protobuf_tensorflow_5fserving_2fapis_2finference_2eproto::AddDescriptors();
  ::tensorflow::serving::protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::AddDescriptors();
