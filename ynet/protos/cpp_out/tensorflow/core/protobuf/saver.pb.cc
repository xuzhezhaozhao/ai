...
void TableStruct::InitDefaultsImpl() {
  ...
  _SaverDef_default_instance_._instance.DefaultConstruct();
...
#if LANG_CXX11
void SaverDef::set_filename_tensor_name(::std::string&& value) {
...
#if LANG_CXX11
void SaverDef::set_save_tensor_name(::std::string&& value) {
...
#if LANG_CXX11
void SaverDef::set_restore_op_name(::std::string&& value) {
