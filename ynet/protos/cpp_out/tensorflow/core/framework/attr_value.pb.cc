...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<NameAttrList::NameAttrList_AttrEntry>
     _instance;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  offsetof(AttrValueDefaultTypeInternal, s_),
  offsetof(AttrValueDefaultTypeInternal, i_),
  offsetof(AttrValueDefaultTypeInternal, f_),
  offsetof(AttrValueDefaultTypeInternal, b_),
  offsetof(AttrValueDefaultTypeInternal, type_),
  offsetof(AttrValueDefaultTypeInternal, shape_),
  offsetof(AttrValueDefaultTypeInternal, tensor_),
  offsetof(AttrValueDefaultTypeInternal, list_),
  offsetof(AttrValueDefaultTypeInternal, func_),
  offsetof(AttrValueDefaultTypeInternal, placeholder_),
...
file_level_metadata[2].reflection = NameAttrList::NameAttrList_AttrEntry::CreateReflection(file_level_metadata[2].descriptor, _NameAttrList_AttrEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _AttrValue_ListValue_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AttrValue_ListValue_default_instance_);_AttrValue_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AttrValue_default_instance_);_NameAttrList_AttrEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_NameAttrList_AttrEntry_default_instance_);_NameAttrList_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_NameAttrList_default_instance_);_AttrValue_default_instance_.s_.UnsafeSetDefault(
  ...
  _AttrValue_default_instance_.placeholder_.UnsafeSetDefault(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
  _NameAttrList_AttrEntry_default_instance_._instance.get_mutable()->set_default_instance(_NameAttrList_AttrEntry_default_instance_._instance.get_mutable());
  _NameAttrList_AttrEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
...
AttrValue_ListValue::AttrValue_ListValue()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tensorflow_2fcore_2fframework_2fattr_5fvalue_2eproto::InitDefaults();
  }
  SharedCtor();
...
#if LANG_CXX11
void AttrValue::set_s(::std::string&& value) {
  // @@protoc_insertion_point(field_set:tensorflow.AttrValue.s)
  if (!has_s()) {
    clear_value();
    set_has_s();
...
#if LANG_CXX11
void AttrValue::set_placeholder(::std::string&& value) {
  // @@protoc_insertion_point(field_set:tensorflow.AttrValue.placeholder)
  if (!has_placeholder()) {
    clear_value();
    set_has_placeholder();
...
#if LANG_CXX11
void NameAttrList::set_name(::std::string&& value) {
