...
#ifndef _KNET_KRANK_STRINGPIECE_H_
#define _KNET_KRANK_STRINGPIECE_H_
...
extern std::ostream& operator<<(std::ostream& o, krank::StringPiece piece);

}  // namespace krank

#endif  // _KNET_KRANK_STRINGPIECE_H_
