...
num_classes=2
pretrained_weights_path=`pwd`/../pretrained_checkpoint/inception_v4.ckpt
train_layers='InceptionV4/Logits/'
exclude_restore_layers='InceptionV4/Logits/,InceptionV4/AuxLogits/'
